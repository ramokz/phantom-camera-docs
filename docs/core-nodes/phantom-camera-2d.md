...
Enable a corresponding layer for a [PhantomCameraNoiseEmitter2D noise_emitter_layer](/secondary-nodes/phantom-camera-noise-emitter-2d#noise_emitter_layer) to make this `PhantomCamera2D` be affected by it.
